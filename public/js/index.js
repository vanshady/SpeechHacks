! function e(t, n, r) {
    ...
    10: [
        function(require, module, exports) {
            ...
            var hescounter = 0, wordcounter = 0;
            var scrolled = !1,
                textScrolled = !1,
                showTimestamp = function(timestamps, confidences) {
                    ...
                    $("#metadataTable > tbody:last-child").append(function(){
      if (word=="%HESITATION")hescounter = hescounter + 1;wordcounter = wordcounter + 1;$(".hesitation").text("Confidence Score:   "+Math.floor((wordcounter-hescounter*3)/wordcounter * 100) + "%");return "<tr><td>" + word + "</td><td>" + t0 + "</td><td>" + t1 + "</td><td>" + displayConfidence + "</td></tr>";})
